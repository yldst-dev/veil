...
- DMG: [veil-0.1.1-arm64.dmg](https://github.com/yldst-dev/veil/releases/download/v0.1.1/veil-0.1.1-arm64.dmg)
- ZIP: [veil-0.1.1-arm64-mac.zip](https://github.com/yldst-dev/veil/releases/download/v0.1.1/veil-0.1.1-arm64-mac.zip)
